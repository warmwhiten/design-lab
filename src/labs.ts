...
export const LABS: Lab[] = [
  ...
  },
  {
    ...
    tagline: "글자를 파고 잉크를 올려 찍는다. 조각도·잉크량·손떨림을 슬라이더로, 활자는 끌어서 배치.",
    description:
      "평범한 폰트를 판화처럼 바꾸는 무료 레터링 도구. 조각도 종류와 크기, 잉크 번짐과 결손, 손떨림과 칼자국을 슬라이더로 만지면 리노컷·목판·고무 스탬프·레터프레스 질감의 글자가 실시간으로 나옵니다. 글자는 캔버스에서 직접 끌어 옮기고 돌릴 수 있고, SVG와 PNG로 저장됩니다. 한글과 직접 올린 폰트도 지원합니다.",
    keywords: [
      "판화 느낌 폰트", "리노컷 타이포그래피", "목판화 글씨", "스탬프 폰트 만들기",
      "빈티지 인쇄 질감", "레터프레스 효과", "거친 질감 로고", "글자 자유 배치",
      "woodcut type generator", "linocut lettering", "block print type"
    ],
    tags: ["타이포그래피", "질감", "인쇄"],
    status: "live",
