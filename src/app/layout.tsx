...
const FONT_ART =
  "https://fonts.googleapis.com/css2?family=Alfa+Slab+One&family=Baloo+2:wght@800&family=Black+Han+Sans&family=Bowlby+One&family=Bungee&family=Fredoka:wght@700&family=Jua&family=Lilita+One&family=Titan+One&display=swap";
